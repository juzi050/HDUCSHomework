...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        # conv5_3
        self.net.createConvLayer('conv5_3', input_shape52, 512, 3, 1, 1, 1)

        # relu5_3
        self.net.createReLuLayer('relu5_3')

        # conv5_4
        self.net.createConvLayer('conv5_4', input_shape52, 512, 3, 1, 1, 1)

        # relu5_4
        self.net.createReLuLayer('relu5_4')

        # pool5
        self.net.createPoolingLayer('pool5', input_shape52, 2, 2)
