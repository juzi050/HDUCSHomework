...
foreach tb_name [list RAM_tb top_tb] {
...
file copy -force [lindex $bit_files 0] [file join $build_dir "Memory_IP_Experiment.bit"]
write_checkpoint -force [file join $build_dir "Memory_IP_Experiment_routed.dcp"]
...
puts "Bitstream generated: [file join $build_dir Memory_IP_Experiment.bit]"
