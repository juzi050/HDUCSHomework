#==============================================================================
# create_project.tcl - Vivado 项目创建脚本 (Experiment 7: Instruction Fetch & Decode)
#==============================================================================
# 功能:
#   - 创建 Vivado 项目，添加取指/译码源文件、仿真文件和约束文件。
#   - 创建 BRAM IP 核 (IM_B: 64x32位, 单端口ROM, 用作指令存储器)。
#   - 从 .coe 文件加载 RISC-V 测试指令。
...
# 设计源文件: PC, IR, 指令存储器, 取指阶段, 立即数单元, 译码, 显示, 顶层
set src_files [list \
...
# 创建 BRAM IP 核: 64x32位单端口ROM (指令存储器), 带初始化文件
