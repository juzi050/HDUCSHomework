#==============================================================================
# run_all.tcl - 一键仿真+综合+实现脚本 (Experiment 7: Instruction Fetch & Decode)
#==============================================================================
# 功能:
...
foreach tb_name [list if_stage_tb id1_tb top_tb] {
...
file copy -force [lindex $bit_files 0] [file join $build_dir "Instruction_Fetch_Decode.bit"]
write_checkpoint -force [file join $build_dir "Instruction_Fetch_Decode_routed.dcp"]
...
puts "Bitstream generated: [file join $build_dir Instruction_Fetch_Decode.bit]"
